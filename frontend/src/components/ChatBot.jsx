      ...
      {!isOpen ? (
        <div className="relative">
          <Button
            ...
            className="h-14 w-14 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-xl transition-all duration-200 transform hover:scale-110 border-2 border-white"
            style={{ 
              position: 'relative',
              zIndex: 10000
            }}
          ...
          {/* Tooltip */}
          <div className="absolute bottom-16 right-0 bg-slate-800 text-white text-sm px-3 py-1 rounded-lg opacity-0 hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap shadow-lg">
        ...
        <Card 
          className={`shadow-2xl border-0 bg-white transition-all duration-300 ${
                ...
                <div className="flex flex-wrap gap-1">
                  {quickActions.map((action, index) => (
                    <Button
                      ...
                      className="h-7 text-xs px-2 hover:bg-blue-50 flex-1 min-w-[80px]"
                    >
                      {action.icon}
